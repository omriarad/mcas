...
int main(void) {
    ...
    std::cout << "Source dir:" << REST_MCAS_SOURCE_DIR << "\n";
    ...
    server.useSSL(REST_MCAS_SOURCE_DIR "certs/server/server.crt",
                  REST_MCAS_SOURCE_DIR "certs/server/server.key");
    server.useSSLAuth(REST_MCAS_SOURCE_DIR "certs/rootCA/rootCA.crt");
...
public:
    ...
    void init(size_t thr = 2)
    {
        ...
        httpEndpoint->useSSL("/home/danielwaddington/mcas/build/dist/certs/mcas-cert.pem",
                             "/home/danielwaddington/mcas/build/dist/certs/mcas-key.pem");
        httpEndpoint->useSSLAuth("/etc/ssl/certs/ca-bundle.crt");
