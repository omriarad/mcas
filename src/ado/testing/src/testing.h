...
#ifndef __TESTING_PLUGIN_COMPONENT_H__
#define __TESTING_PLUGIN_COMPONENT_H__

#include <api/ado_itf.h>


class ADO_testing_plugin : public component::IADO_plugin
{
private:
