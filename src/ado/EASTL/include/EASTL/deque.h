...
namespace eastl
{
	...
	///
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	struct DequeIterator
	{
		typedef DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked> this_type;
		typedef DequeIterator<T, T*, T&, kDequeSubarraySize, false>       iterator;
		typedef DequeIterator<T, T*, T&, kDequeSubarraySize, true>        tracked_iterator;
		typedef DequeIterator<T, const T*, const T&, kDequeSubarraySize, false> const_iterator;
	...
	protected:
		template <typename, typename, typename, unsigned, bool>
		...
		template <typename U, typename PointerA, typename ReferenceA, typename PointerB, typename ReferenceB, unsigned kDequeSubarraySizeU, bool kTrackedU>
		friend bool operator==(const DequeIterator<U, PointerA, ReferenceA, kDequeSubarraySizeU, kTrackedU>&, 
							   const DequeIterator<U, PointerB, ReferenceB, kDequeSubarraySizeU, kTrackedU>&);

		template <typename U, typename PointerA, typename ReferenceA, typename PointerB, typename ReferenceB, unsigned kDequeSubarraySizeU, bool kTrackedA, bool kTrackedB>
		friend bool operator!=(const DequeIterator<U, PointerA, ReferenceA, kDequeSubarraySizeU, kTrackedA>&, 
							   const DequeIterator<U, PointerB, ReferenceB, kDequeSubarraySizeU, kTrackedB>&);

		template <typename U, typename PointerU, typename ReferenceU, unsigned kDequeSubarraySizeU, bool kTrackedU>
		friend bool operator!=(const DequeIterator<U, PointerU, ReferenceU, kDequeSubarraySizeU, kTrackedU>& a, 
							   const DequeIterator<U, PointerU, ReferenceU, kDequeSubarraySizeU, kTrackedU>& b);
		...
		template <typename U, typename PointerA, typename ReferenceA, typename PointerB, typename ReferenceB, unsigned kDequeSubarraySizeU, bool kTrackedA, bool kTrackedB>
		friend typename DequeIterator<U, PointerA, ReferenceA, kDequeSubarraySizeU, kTrackedA>::difference_type
		operator-(const DequeIterator<U, PointerA, ReferenceA, kDequeSubarraySizeU, kTrackedA>& a,
				  const DequeIterator<U, PointerB, ReferenceB, kDequeSubarraySizeU, kTrackedB>& b);
 ...
 */
		using internal_ptr = typename std::conditional<kTracked, tracked<T*, '1'>, T *>::type;
		...
		using internal_array_ptr = typename std::conditional<kTracked, tracked<T**, 'A'>, T **>::type;
	...
	{
	protected:
		typedef DequeIterator<T, T*, T&, kDequeSubarraySize, true>       internal_iterator;
	public:
		typedef T                                                        value_type;
	...
	protected:
		tracked<T**, 'D'>            mpPtrArray;         // Array of pointers to subarrays.
		tracked<size_type, 'S'>      mnPtrArraySize;     // Possibly we should store this as T** mpArrayEnd.
	...
	void DequeBase<T, Allocator, kDequeSubarraySize>::DoReallocPtrArray(size_type nAdditionalCapacity, Side allocationSide)
	{
		...
		if((allocationSide == kSideBack) && (nAdditionalCapacity <= nUnusedPtrCountAtFront))  // If we can take advantage of unused pointers at the front without doing any reallocation...
		{
			...
			tracking::memmove(pPtrArrayBegin, mItBegin.mpCurrentArrayPtr, nUsedPtrSpace);
		...
		else
		{
			...
			{
				tracking::memcpy(pPtrArrayBegin, mItBegin.mpCurrentArrayPtr, nUsedPtrSpace);
			}
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::DequeIterator()
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::DequeIterator(T** pCurrentArrayPtr, T* pCurrent)
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::DequeIterator(const iterator& x)
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::DequeIterator(const tracked_iterator& x)
		: mpCurrent(x.mpCurrent), mpBegin(x.mpBegin), mpEnd(x.mpEnd), mpCurrentArrayPtr(x.mpCurrentArrayPtr)
	{
		// Empty
	}
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::DequeIterator(const iterator& x, Increment)
		: mpCurrent(x.mpCurrent), mpBegin(x.mpBegin), mpEnd(x.mpEnd), mpCurrentArrayPtr(x.mpCurrentArrayPtr)
	{
		operator++();
	}
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::DequeIterator(const iterator& x, Decrement)
		: mpCurrent(x.mpCurrent), mpBegin(x.mpBegin), mpEnd(x.mpEnd), mpCurrentArrayPtr(x.mpCurrentArrayPtr)
	{
		operator--();
	}
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	typename DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::pointer
	DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::operator->() const
	{
		return mpCurrent;
	}
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	typename DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::reference
	DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::operator*() const
	{
		return *mpCurrent;
	}
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	typename DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::this_type&
	DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::operator++()
	{
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	typename DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::this_type
	DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::operator++(int)
	{
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	typename DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::this_type&
	DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::operator+=(difference_type n)
	{
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	typename DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::this_type
	DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::operator+(difference_type n) const
	{
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	typename DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::this_type
	DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::copy(const iterator& first, const iterator& last, true_type)
	{
		...
		{
			tracking::memmove(mpCurrent, first.mpCurrent, (last.mpCurrent - first.mpCurrent) * (sizeof *last.mpCurrent));
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	typename DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::this_type
	DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::copy(const iterator& first, const iterator& last, false_type)
	{
		return eastl::copy(eastl::make_move_iterator(first), eastl::make_move_iterator(last), eastl::make_move_iterator(*this)).base();
	}
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	void DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::copy_backward(const iterator& first, const iterator& last, true_type)
	{
		...
		{
			tracking::memmove(mpCurrent - (last.mpCurrent - first.mpCurrent), first.mpCurrent, (last.mpCurrent - first.mpCurrent) * (sizeof *last.mpCurrent));
		}
		else
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	void DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::copy_backward(const iterator& first, const iterator& last, false_type)
	{
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	void DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>::SetSubarray(T** pCurrentArrayPtr)
	{
	...
	template <typename T, typename PointerA, typename ReferenceA, typename PointerB, typename ReferenceB, unsigned kDequeSubarraySize, bool kTracked>
	inline bool operator==(const DequeIterator<T, PointerA, ReferenceA, kDequeSubarraySize, kTracked>& a, 
						   const DequeIterator<T, PointerB, ReferenceB, kDequeSubarraySize, kTracked>& b)
	{
		return a.mpCurrent == b.mpCurrent;
	}


	template <typename T, typename PointerA, typename ReferenceA, typename PointerB, typename ReferenceB, unsigned kDequeSubarraySize, bool kTrackedA, bool kTrackedB>
	inline bool operator!=(const DequeIterator<T, PointerA, ReferenceA, kDequeSubarraySize, kTrackedA>& a, 
						   const DequeIterator<T, PointerB, ReferenceB, kDequeSubarraySize, kTrackedB>& b)
	{
		return a.mpCurrent != b.mpCurrent;
	}
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	inline bool operator!=(const DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>& a, 
						   const DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>& b)
	{
		return a.mpCurrent != b.mpCurrent;
	}
	...
	template <typename T, typename Pointer, typename Reference, unsigned kDequeSubarraySize, bool kTracked>
	inline DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>
	operator+(ptrdiff_t n, const DequeIterator<T, Pointer, Reference, kDequeSubarraySize, kTracked>& x)
	{
	...
	template <typename T, typename PointerA, typename ReferenceA, typename PointerB, typename ReferenceB, unsigned kDequeSubarraySize, bool kTrackedA, bool kTrackedB>
	inline typename DequeIterator<T, PointerA, ReferenceA, kDequeSubarraySize, kTrackedA>::difference_type
	operator-(const DequeIterator<T, PointerA, ReferenceA, kDequeSubarraySize, kTrackedA>& a,
			  const DequeIterator<T, PointerB, ReferenceB, kDequeSubarraySize, kTrackedB>& b)
	{
		// This is a fairly clever algorithm that has been used in STL deque implementations since the original HP STL:
		typedef typename DequeIterator<T, PointerA, ReferenceA, kDequeSubarraySize, kTrackedA>::difference_type difference_type;
