...
class MCAS_client : public virtual Component::IKVStore,
                    public virtual Component::IMCAS
{
 ...
 public:
  ...
  void* query_interface(Component::uuid_t& itf_uuid) override
  {
    if (itf_uuid == Component::IKVStore::iid()) {
      ...
      return (void*) static_cast<Component::IMCAS*>(this);
    }
    else {
 ...
 private:
  ...
  mcas::Client::Connection_handler* _connection;
 ...
 public:
  ...
  void* query_interface(Component::uuid_t& itf_uuid) override
  {
    if (itf_uuid == Component::IMCAS_factory::iid()) {
      return (void*) static_cast<Component::IMCAS_factory*>(this);
    }
  ...
  {
    Component::IMCAS* obj =
      static_cast<Component::IMCAS*>(new MCAS_client(debug_level, owner, addr, device));
    obj->add_ref();
    return obj;
  }
                               ...
                               const std::string& device) override
  {
    Component::IKVStore* obj =
      static_cast<Component::IKVStore*>(new MCAS_client(debug_level, owner, addr, device));
    obj->add_ref();
    return obj;
  }
