...
public:
  ...
  void post_send(
    ...
    , void **desc
    , void *context
  ) override { return Fabric_connection_server::post_send(buffers, desc, context); }
  ...
  void post_recv(
    ...
    , void **desc
    , void *context
  ) override { return Fabric_connection_server::post_recv(buffers, desc, context); }
  ...
  void post_read(
    ...
    , std::uint64_t key
    , void *context
  ) override { return Fabric_op_control::post_read(buffers, desc, remote_addr, key, context); }
  void post_read(
    gsl::span<const ::iovec> buffers,
    std::uint64_t remote_addr,
    std::uint64_t key,
  ...
  void post_write(
    ...
    , std::uint64_t key
    , void *context
  ) override { return Fabric_op_control::post_write(buffers, desc, remote_addr, key, context); }
  void post_write(
    gsl::span<const ::iovec> buffers,
    std::uint64_t remote_addr,
    std::uint64_t key,
