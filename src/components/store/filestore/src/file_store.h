...
class File_store
    : public Component::IKVStore /* generic Key-Value store interface */
{
 private:
 ...
 public:
                                      ...
                                      const std::string &name) override
  {
    Component::IKVStore *obj =
        static_cast<Component::IKVStore *>(new File_store("/"));
    obj->add_ref();
    return obj;
  }
      ...
      std::map<std::string, std::string> &params)
  {
    ...
    Component::IKVStore *obj =
        static_cast<Component::IKVStore *>(new File_store(params["pm_path"]));
    obj->add_ref();
    return obj;
  }
};
