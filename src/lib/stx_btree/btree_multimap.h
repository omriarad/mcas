...
public:
    ...
    typedef btree_multimap<key_type, data_type, _InnerSlots, _LeafSlots, key_compare, traits, allocator_type>    self;
    ...
    typedef stx::btree<key_type, data_type, _InnerSlots, _LeafSlots, value_type, key_compare,
