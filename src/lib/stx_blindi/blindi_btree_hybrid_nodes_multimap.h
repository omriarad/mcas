/** \file blindi_btree_hybrid_nodes_multimap.h
 * Contains the specialized B+ tree template class blindi_btree_hybrid_nodes_multimap
 */
...
#ifndef _STX_BLINDI_BTREE_HYBRID_NODES_MULTIMAP_H_
#define _STX_BLINDI_BTREE_HYBRID_NODES_MULTIMAP_H_

#include "blindi_btree_hybrid_nodes.h"
...
class blindi_btree_hybrid_nodes_multimap
{
public:
...
public:
    ...
    typedef blindi_btree_hybrid_nodes_multimap<key_type, data_type, BlindiBtreeHybridType, _InnerSlots, _LeafSlots, key_compare, traits, allocator_type>    self;
    ...
    typedef stx::blindi_btree_hybrid_nodes<key_type, data_type, BlindiBtreeHybridType, _InnerSlots, _LeafSlots, value_type, key_compare,
...
public:
    ...
    /// comparison function
    explicit inline blindi_btree_hybrid_nodes_multimap(const allocator_type &alloc = allocator_type())
        : tree(alloc)
    {
    }
    ...
    /// comparison object
    explicit inline blindi_btree_hybrid_nodes_multimap(const key_compare &kcf,
    ...
    inline blindi_btree_hybrid_nodes_multimap(InputIterator first, InputIterator last,
                          const allocator_type &alloc = allocator_type())
    ...
    template <class InputIterator>
    inline blindi_btree_hybrid_nodes_multimap(InputIterator first, InputIterator last, const key_compare &kcf,
                          const allocator_type &alloc = allocator_type())
    ...
    inline ~blindi_btree_hybrid_nodes_multimap()
    {
    }
...
public:
    ...
    inline blindi_btree_hybrid_nodes_multimap(const self &other)
        : tree(other.tree)
    {
    }
