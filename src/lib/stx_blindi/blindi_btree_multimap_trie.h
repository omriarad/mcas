...
#ifndef _STX_BLINDI_BTREE_TRIE_MULTIMAP_H_
#define _STX_BLINDI_BTREE_TRIE_MULTIMAP_H_

#include "blindi_btree_trie.h"
...
template <typename _Key, typename _Data, template<typename, int> typename BlindiTrieType,
          ...
          typename _Traits = blindi_btree_trie_default_map_traits<_InnerSlots, _LeafSlots>,
          typename _Alloc = std::allocator<std::pair<_Key, _Data> > >
class blindi_btree_multimap_trie
{
public:
...
public:
    ...
    typedef blindi_btree_multimap_trie<key_type, data_type, BlindiTrieType, _InnerSlots, _LeafSlots, key_compare, traits, allocator_type>    self;
    ...
    typedef stx::blindi_btree_trie<key_type, data_type, BlindiTrieType, _InnerSlots, _LeafSlots, value_type, key_compare,
...
public:
    ...
    /// comparison function
    explicit inline blindi_btree_multimap_trie(const allocator_type &alloc = allocator_type())
        : tree(alloc)
    {
    }
    ...
    /// comparison object
    explicit inline blindi_btree_multimap_trie(const key_compare &kcf,
    ...
    inline blindi_btree_multimap_trie(InputIterator first, InputIterator last,
                          const allocator_type &alloc = allocator_type())
    ...
    template <class InputIterator>
    inline blindi_btree_multimap_trie(InputIterator first, InputIterator last, const key_compare &kcf,
                          const allocator_type &alloc = allocator_type())
    ...
    inline ~blindi_btree_multimap_trie()
    {
    }
...
public:
    ...
    inline blindi_btree_multimap_trie(const self &other)
        : tree(other.tree)
    {
    }
...
#endif // _STX_BLINDI_BTREE_TRIE_MULTIMAP_H_
