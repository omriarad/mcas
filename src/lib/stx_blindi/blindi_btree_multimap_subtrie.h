...
#ifndef _STX_BLINDI_BTREE_SUBTRIE_MULTIMAP_H_
#define _STX_BLINDI_BTREE_SUBTRIE_MULTIMAP_H_

#include "blindi_btree_subtrie.h"
...
template <typename _Key, typename _Data, template<typename, int> typename BlindiSubTrieType,
          ...
          typename _Traits = blindi_btree_subtrie_default_map_traits<_InnerSlots, _LeafSlots>,
          typename _Alloc = std::allocator<std::pair<_Key, _Data> > >
class blindi_btree_multimap_subtrie
{
public:
...
public:
    ...
    typedef blindi_btree_multimap_subtrie<key_type, data_type, BlindiSubTrieType, _InnerSlots, _LeafSlots, key_compare, traits, allocator_type>    self;
    ...
    typedef stx::blindi_btree_subtrie<key_type, data_type, BlindiSubTrieType, _InnerSlots, _LeafSlots, value_type, key_compare,
...
public:
    ...
    /// comparison function
    explicit inline blindi_btree_multimap_subtrie(const allocator_type &alloc = allocator_type())
        : tree(alloc)
    {
    }
    ...
    /// comparison object
    explicit inline blindi_btree_multimap_subtrie(const key_compare &kcf,
    ...
    inline blindi_btree_multimap_subtrie(InputIterator first, InputIterator last,
                          const allocator_type &alloc = allocator_type())
    ...
    template <class InputIterator>
    inline blindi_btree_multimap_subtrie(InputIterator first, InputIterator last, const key_compare &kcf,
                          const allocator_type &alloc = allocator_type())
    ...
    inline ~blindi_btree_multimap_subtrie()
    {
    }
...
public:
    ...
    /// SubTries to locate a key in the B+ tree and returns an iterator to the
...
public:
    ...
    inline blindi_btree_multimap_subtrie(const self &other)
        : tree(other.tree)
    {
    }
...
public:
    ...
    inline iterator upsert(const key_type& key, const data_type& data)
    {
        return tree.upsert(key, data).first;
    }
...
#endif // _STX_BLINDI_BTREE_SUBTRIE_MULTIMAP_H_
