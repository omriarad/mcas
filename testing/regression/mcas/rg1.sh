...
do for lg in 23
	do sz=$((1<<lg))
		# STORE_SIZE assumes that only 1000a of the elements will be needed (i.i, that exp_perf_cirect,s is modified to us ony a few
		...
		VALUE_LENGTH=$sz ELEMENT_COUNT=1 CLIENT_HOST=sg-mcas107.sg.almaden.ibm.com CLIENT_CORE_BASE=1 CLIENT_CORE_STRIDE=5 SHARD_COUNT=$ct \
