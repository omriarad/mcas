pipeline {
  ...
  stages {
	...
	cd ${WORKSPACE}/build
	export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:${WORKSPACE}/build/dist/lib:${WORKSPACE}/build/dist/lib64 ./dist/testing/run-tests.sh release &> results.log
